...
class MovieRemoteDataSourceImpl implements MovieRemoteDataSource {
  ...
  static final List<BannerSlideModel> _mockBanners = [
    ...
    const BannerSlideModel(
      ...
      title: '🐼🍿 Special Exclusive...',
      khmerTitle: 'ប្រូម៉ូសិនពិសេសផ្ដាច់មុខជាមួយ Foodpanda',
      subtitle: '🐼🍿 Special Exclusive Promotion with Foodpanda! 🎬✨ Popcorn lovers, don\'t miss out on this special promotion! 😍 Big Popcorn Bucket + Free Cold Coke Drink for only \$5.90!',
    ...
    const BannerSlideModel(
      ...
      khmerTitle: 'Sabay Cinema x ABA Bank Campaign',
      subtitle: 'Pay via ABA KHQR for tickets & snacks to enter the draw to win Singapore trip for 4, iPad Air M4 & 900 free movie tickets! ✈️🎁',
      tag: 'SPECIAL PROMO',
    ...
    const BannerSlideModel(
      ...
      subtitle: 'Show your student ID every Wednesday for 50% OFF all 2D & 3D movie tickets at all Sabay Cinema branches! 🎟️✨',
      tag: '50% OFF STUDENT',
